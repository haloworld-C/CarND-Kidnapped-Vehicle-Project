...
public:
     ...
     * @note: this function will throw standard exception
     */
    ...
    /**
     * @brief: set gassian distribution for particles
     * @param: std[], the stdev for distribution 
    */
    void setUncertain(Particle& particle, double std[]);
